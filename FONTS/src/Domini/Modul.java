...
/**Classe Modul, la qual hereta de la classe abstracta Operacio*/
public class Modul extends Operacio {
    ...
    /** Comprova que el mòdul dels valors del vector de caselles de la Zona z sigui igual al resultat de z
